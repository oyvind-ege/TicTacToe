...
class LogicChecker:
    ...
    def would_this_be_a_draw(self, symbol, empty_tiles_coordinates):
        ...
        if self.turn >= 7 and self.turn < 8: #There are two open tiles left, next_symbol == 'O'
            ...
            scenario1_boolean = (   not self.is_this_move_a_victory(symbol, *empty_tiles_coordinates[0]) 
            ...
            scenario2_boolean = (   not self.is_this_move_a_victory(symbol, *empty_tiles_coordinates[1])
